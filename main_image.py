...
#     # Display the resulting frame with the filled dots
#     cv2.imshow('Face Detection with Dots', frame)
...
while True:
    ...
    # Detect emotions in the frame using FER
    ...
    # Display the resulting frame with the filled dots and emotion chart
